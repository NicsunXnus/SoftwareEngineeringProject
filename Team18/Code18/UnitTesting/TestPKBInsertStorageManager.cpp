	...
	TEST_CLASS(TestPKBInsertStorageManager) {
		public:
			...
			TEST_METHOD(TestAddFollowsAbstractionSuccess) {
				...
				shared_ptr<map<string, unordered_set<string>>> toInsert = make_shared<map<string, unordered_set<string>>>(followsData);
				...
				shared_ptr<map<string, unordered_set<string>>> db = follows_storage->getDatabase();
			...
			TEST_METHOD(TestAddFollowsStarAbstractionSuccess) {
				...
				shared_ptr<map<string, unordered_set<string>>> toInsert = make_shared<map<string, unordered_set<string>>>(followsStarData);
				...
				shared_ptr<map<string, unordered_set<string>>> db = followsstar_storage->getDatabase();
			...
			TEST_METHOD(TestAddParentAbstractionSuccess) {
				...
				shared_ptr<map<string, unordered_set<string>>> toInsert = make_shared<map<string, unordered_set<string>>>(parentData);
				...
				shared_ptr<map<string, unordered_set<string>>> db = parent_storage->getDatabase();
			...
			TEST_METHOD(TestAddParentStarAbstractionSuccess) {
				...
				shared_ptr<map<string, unordered_set<string>>> toInsert = make_shared<map<string, unordered_set<string>>>(parentStarData);
				...
				shared_ptr<map<string, unordered_set<string>>> db = parentstar_storage->getDatabase();
			...
			TEST_METHOD(TestAddCallsAbstractionSuccess) {
				...
				shared_ptr<map<string, unordered_set<string>>> toInsert = make_shared<map<string, unordered_set<string>>>(callsData);
				...
				shared_ptr<map<string, unordered_set<string>>> db = calls_storage->getDatabase();
			...
			TEST_METHOD(TestAddCallsStarAbstractionSuccess) {
				...
				shared_ptr<map<string, unordered_set<string>>> db = callsstar_storage->getDatabase();
			...
			TEST_METHOD(TestAddZeroAbstractionSuccess) {
				...
				shared_ptr<map<string, unordered_set<string>>> parent_db = parent_storage->getDatabase();
				shared_ptr<map<string, unordered_set<string>>> parentstar_db = parentstar_storage->getDatabase();
				shared_ptr<map<string, unordered_set<string>>> follows_db = follows_storage->getDatabase();
				shared_ptr<map<string, unordered_set<string>>> followsstar_db = followsstar_storage->getDatabase();
				shared_ptr<map<string, unordered_set<string>>> modifies_db = modifies_storage->getDatabase();
				shared_ptr<map<string, unordered_set<string>>> uses_db = uses_storage->getDatabase();
			...
			TEST_METHOD(TestAddMultipleAbstractionsSuccess) {
				...
				shared_ptr<map<string, unordered_set<string>>> toInsertUses = make_shared<map<string, unordered_set<string>>>(usesData);
				shared_ptr<map<string, unordered_set<string>>> toInsertModifies = make_shared<map<string, unordered_set<string>>>(modifiesData);
				shared_ptr<map<string, unordered_set<string>>> toInsertFollowsStar = make_shared<map<string, unordered_set<string>>>(followsStarData);
				shared_ptr<map<string, unordered_set<string>>> toInsertFollows = make_shared<map<string, unordered_set<string>>>(followsData);
				shared_ptr<map<string, unordered_set<string>>> toInsertParentStar = make_shared<map<string, unordered_set<string>>>(parentStarData);
				shared_ptr<map<string, unordered_set<string>>> toInsertParent = make_shared<map<string, unordered_set<string>>>(parentData);
