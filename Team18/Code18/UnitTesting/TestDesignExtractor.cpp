...
namespace UnitTesting
{
	...
	public:
		TEST_METHOD(TestSimpleASTExtraction)
		{
            ...
            Assert::AreEqual(statementMap["read"][0], std::string("1"));
            Assert::AreEqual(statementMap["read"][1], std::string("5"));
            Assert::AreEqual(statementMap["print"][0], std::string("2"));
            Assert::AreEqual(statementMap["print"][1], std::string("4"));
            Assert::AreEqual(statementMap["assign"][0], std::string("3"));
            
            //Check if the variable entity is extracted correctly
            Assert::AreEqual(variableMap["x"][0], std::string("1"));
            Assert::AreEqual(variableMap["y"][0], std::string("2"));
            Assert::AreEqual(variableMap["x"][1], std::string("4"));
            Assert::AreEqual(variableMap["x"][2], std::string("5"));
            Assert::AreEqual(variableMap["z"][0], std::string("3"));
