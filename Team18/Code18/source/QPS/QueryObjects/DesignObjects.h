...
class DesignObject : public QueryObject {
 public:
  DesignObject(string_view data) : QueryObject{data} {}
};
...
class StmtObject : public DesignObject {
 public:
  StmtObject(string_view data) : DesignObject{data} {};
  shared_ptr<QueryResultsTable> callAndProcess(
    ...
    shared_ptr<QueryResultsTable> table = QueryResultsTable::createTable(
        svToString(getQueryObjectName()), PKBdata);
...
class ReadObject : public DesignObject {
 public:
  ReadObject(string_view data) : DesignObject{data} {};
  shared_ptr<QueryResultsTable> callAndProcess(
      shared_ptr<DataAccessLayer> dataAccessLayer) override {
...
class PrintObject : public DesignObject {
 public:
  PrintObject(string_view data) : DesignObject{data} {};
  shared_ptr<QueryResultsTable> callAndProcess(
      shared_ptr<DataAccessLayer> dataAccessLayer) override {
...
class CallObject : public DesignObject {
 public:
  CallObject(string_view data) : DesignObject{data} {};
  shared_ptr<QueryResultsTable> callAndProcess(
      shared_ptr<DataAccessLayer> dataAccessLayer) override {
...
class WhileObject : public DesignObject {
 public:
  WhileObject(string_view data) : DesignObject{data} {};
  shared_ptr<QueryResultsTable> callAndProcess(
      shared_ptr<DataAccessLayer> dataAccessLayer) override {
...
class IfObject : public DesignObject {
 public:
  IfObject(string_view data) : DesignObject{data} {};
  shared_ptr<QueryResultsTable> callAndProcess(
      shared_ptr<DataAccessLayer> dataAccessLayer) override {
...
class AssignObject : public DesignObject {
 public:
  AssignObject(string_view data) : DesignObject{data} {};
  shared_ptr<QueryResultsTable> callAndProcess(
      shared_ptr<DataAccessLayer> dataAccessLayer) override {
...
class VariableObject : public DesignObject {
 public:
  VariableObject(string_view data) : DesignObject{data} {};
  shared_ptr<QueryResultsTable> callAndProcess(
      shared_ptr<DataAccessLayer> dataAccessLayer) override {
...
class ConstantObject : public DesignObject {
 public:
  ConstantObject(string_view data) : DesignObject{data} {};
  shared_ptr<QueryResultsTable> callAndProcess(
      shared_ptr<DataAccessLayer> dataAccessLayer) override {
...
class ProcedureObject : public DesignObject {
 public:
  ProcedureObject(string_view data) : DesignObject{data} {};
  shared_ptr<QueryResultsTable> callAndProcess(
      shared_ptr<DataAccessLayer> dataAccessLayer) override {
