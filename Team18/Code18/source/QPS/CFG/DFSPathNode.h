...
public:
  ...
  // Replaces the "current" with each cached PathNode supplied, by creating new copies of the parents. This essentially joins the descendants
  // from the cached toJoin to the new paths generated by the DFS via current.
