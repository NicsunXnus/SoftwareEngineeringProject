...
public:
    ...
    /// <summary>
    /// These extract functions are used in the different extractors based on their needs 
    ...
    /// <summary>
    /// These extract functions are meant to be overriden in ProcedureLineNumberExtractor
    ...
    /// <summary>
    /// These extract functions are meant to be overriden in NextExtractor
