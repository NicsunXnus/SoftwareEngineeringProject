...
public:
    ...
    shared_ptr<unordered_map<string, unordered_set<string>>> getProcedureSetMap();
    shared_ptr<unordered_map<string, unordered_set<string>>> getStatementSetMap();
    shared_ptr<unordered_map<string, unordered_set<string>>> getVariableSetMap();
    shared_ptr<unordered_map<string, unordered_set<string>>> getConstantSetMap();
    ...
    shared_ptr<unordered_map<string, unordered_set<string>>> getParentMap();
    shared_ptr<unordered_map<string, unordered_set<string>>> getParentStarMap();
    shared_ptr<unordered_map<string, unordered_set<string>>> getFollowsMap();
    shared_ptr<unordered_map<string, unordered_set<string>>> getFollowsStarMap();
    shared_ptr<unordered_map<string, unordered_set<string>>> getUsesMap();
    shared_ptr<unordered_map<string, unordered_set<string>>> getModifiesMap();
    shared_ptr<unordered_map<string, unordered_set<string>>> getCallsMap();
    shared_ptr<unordered_map<string, unordered_set<string>>> getCallsStarMap();
    shared_ptr<unordered_map<string, unordered_set<string>>> getNextMap();
