...
shared_ptr<unordered_map<string, unordered_set<string>>> DesignExtractor::getProcedureSetMap() {
    return this->entityExtractor->getProcedureMap();
}
shared_ptr<unordered_map<string, unordered_set<string>>> DesignExtractor::getStatementSetMap() {
    return this->entityExtractor->getStatementMap();
}
shared_ptr<unordered_map<string, unordered_set<string>>> DesignExtractor::getVariableSetMap() {
    return this->entityExtractor->getVariableMap();
}
shared_ptr<unordered_map<string, unordered_set<string>>> DesignExtractor::getConstantSetMap() {
    return this->entityExtractor->getConstantMap();
}
shared_ptr<unordered_map<string, unordered_set<string>>> DesignExtractor::getCallProcNameMap() {
    return this->entityExtractor->getCallProcNameMap();
}
shared_ptr<unordered_map<string, unordered_set<string>>> DesignExtractor::getReadVarNameMap() {
    return this->entityExtractor->getReadVarNameMap();
}
shared_ptr<unordered_map<string, unordered_set<string>>> DesignExtractor::getPrintVarNameMap() {
...
shared_ptr<unordered_map<string, unordered_set<string>>> DesignExtractor::getParentMap() {
    return this->parentsExtractor->getStorageMap();
}
shared_ptr<unordered_map<string, unordered_set<string>>> DesignExtractor::getParentStarMap() {
    return this->parentsExtractor->getStorageStarMap();
}
shared_ptr<unordered_map<string, unordered_set<string>>> DesignExtractor::getFollowsMap() {
    return this->followsExtractor->getStorageMap();
}
shared_ptr<unordered_map<string, unordered_set<string>>> DesignExtractor::getFollowsStarMap() {
    return this->followsExtractor->getStorageStarMap();
}
shared_ptr<unordered_map<string, unordered_set<string>>> DesignExtractor::getUsesMap() {
    return this->usesExtractor->getStorageMap();
}
shared_ptr<unordered_map<string, unordered_set<string>>> DesignExtractor::getModifiesMap() {
    return this->modifiesExtractor->getStorageMap();
}
shared_ptr<unordered_map<string, unordered_set<string>>> DesignExtractor::getCallsMap() {
    return this->callsExtractor->getStorageMap();
}
shared_ptr<unordered_map<string, unordered_set<string>>> DesignExtractor::getCallsStarMap() {
    return this->callsExtractor->getStorageStarMap();
}
shared_ptr<unordered_map<string, unordered_set<string>>> DesignExtractor::getNextMap() {
...
void DesignExtractor::insertEntities() {
    // Get the entity maps
    static shared_ptr<unordered_map<string, unordered_set<string>>> procedureSet = this->entityExtractor->getProcedureMap();
    static shared_ptr<unordered_map<string, unordered_set<string>>> variableSet = this->entityExtractor->getVariableMap();
    static shared_ptr<unordered_map<string, unordered_set<string>>> constantSet = this->entityExtractor->getConstantMap();
    static shared_ptr<unordered_map<string, unordered_set<string>>> statementSet = this->entityExtractor->getStatementMap();
    static shared_ptr<unordered_map<string, unordered_set<string>>> callProcNameMap = this->entityExtractor->getCallProcNameMap();
    static shared_ptr<unordered_map<string, unordered_set<string>>> readVarNameMap = this->entityExtractor->getReadVarNameMap();
    static shared_ptr<unordered_map<string, unordered_set<string>>> printVarNameMap = this->entityExtractor->getPrintVarNameMap();
    static shared_ptr<unordered_map<string, shared_ptr<Node>>> patternMap = this->entityExtractor->getPatternMap();
    static shared_ptr<unordered_map<string, pair<string, string>>> procedureStatementStorageMap = this->procedureLineNumberExtractor->getProcedureStatementStorageMap();
...
void DesignExtractor::insertAbstractions() {
    ...
    static shared_ptr<unordered_map<string, unordered_set<string>>>  parentsSet = this->parentsExtractor->getStorageMap();
    static shared_ptr<unordered_map<string, unordered_set<string>>>  followsSet = this->followsExtractor->getStorageMap();
    static shared_ptr<unordered_map<string, unordered_set<string>>>  parentsStarSet = this->parentsExtractor->getStorageStarMap();
    static shared_ptr<unordered_map<string, unordered_set<string>>>  followsStarSet = this->followsExtractor->getStorageStarMap();
    static shared_ptr<unordered_map<string, unordered_set<string>>>  callSet = this->callsExtractor->getStorageMap();
    static shared_ptr<unordered_map<string, unordered_set<string>>>  callStarSet = this->callsExtractor->getStorageStarMap();
    static shared_ptr<unordered_map<string, unordered_set<string>>> modifiesSet = this->modifiesExtractor->getStorageMap();
    static shared_ptr<unordered_map<string, unordered_set<string>>> usesSet = this->usesExtractor->getStorageMap();
    static shared_ptr<unordered_map<string, unordered_set<string>>> nextSet = this->nextExtractor->getStorageMap();
