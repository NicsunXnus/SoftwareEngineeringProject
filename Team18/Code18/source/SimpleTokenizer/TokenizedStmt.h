...
///
/// Wrapper for a vector of tokens. Note that semicolons will NO LONGER be
/// stored, since some statements will not end in semicolons
///
...
class TokenizedStmt {
 ...
 public:
  ...
  int getStatementNumber() { return this->statementNumber; }
