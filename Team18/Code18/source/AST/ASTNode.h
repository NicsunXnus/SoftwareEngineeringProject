...
class ASTNode {
 public:
  ...
  int getStatementNumber() const { return statementNumber; }

  bool isStatement() const { return statementNumber > 0; }
  ...
  virtual std::vector<std::shared_ptr<StatementNode>> getElseStatements()
      const {
    std::vector<std::shared_ptr<StatementNode>> statements;
    return statements;
  }
...
class AssignNode : public StatementNode {
 public:
  AssignNode(int statementNumber, std::shared_ptr<ExprNode> variable,
             std::shared_ptr<ExprNode> expr)
      : StatementNode(std::move(std::string("assign")), statementNumber),
        variable(variable),
        expr(expr) {}

  std::shared_ptr<ExprNode> getVar() const override { return this->variable; }
  std::shared_ptr<ExprNode> getExpr() const override { return this->expr; }
...
class CallNode : public StatementNode {
 public:
  CallNode(int statementNumber, std::shared_ptr<ProcedureNode> proc)
      : StatementNode(std::move(std::string("call")), statementNumber),
        proc(proc) {}
  std::shared_ptr<ProcedureNode> getProc() const override { return this->proc; }
...
class ReadNode : public StatementNode {
 public:
  ReadNode(int statementNumber, std::shared_ptr<ExprNode> variable)
      : StatementNode(std::move(std::string("read")), statementNumber),
        variable(variable) {}
  std::shared_ptr<ExprNode> getVar() const override { return this->variable; }
...
class PrintNode : public StatementNode {
 public:
  PrintNode(int statementNumber, std::shared_ptr<ExprNode> variable)
      : StatementNode(std::move(std::string("print")), statementNumber),
        variable(variable) {}
  std::shared_ptr<ExprNode> getVar() const override { return this->variable; }
...
class IfNode : public StatementNode {
 public:
  IfNode(int statementNumber, std::shared_ptr<CondExprNode> condExpr,
         std::vector<std::shared_ptr<StatementNode>> thenStmts,
         std::vector<std::shared_ptr<StatementNode>> elseStmts)
      : StatementNode(std::move(std::string("if")), statementNumber),
        condExpr(condExpr),
        thenStmts(thenStmts),
        elseStmts(elseStmts) {}
  ...
  std::vector<std::shared_ptr<StatementNode>> getElseStatements()
      const override {
...
class WhileNode : public StatementNode {
 public:
  WhileNode(int statementNumber, std::shared_ptr<CondExprNode> condExpr,
            std::vector<std::shared_ptr<StatementNode>> loopStmts)
      : StatementNode(std::move(std::string("while")), statementNumber),
        condExpr(condExpr),
        loopStmts(loopStmts) {}
  std::shared_ptr<CondExprNode> getCondExpr() const override {
    return this->condExpr;
...
class DividesNode : public ExprNode {
 public:
  DividesNode(std::shared_ptr<ExprNode> leftExpr,
...
class MinusNode : public ExprNode {
 public:
  MinusNode(std::shared_ptr<ExprNode> leftExpr,
            std::shared_ptr<ExprNode> rightExpr)
...
class ModNode : public ExprNode {
 public:
  ModNode(std::shared_ptr<ExprNode> leftExpr,
          std::shared_ptr<ExprNode> rightExpr)
...
class PlusNode : public ExprNode {
 public:
  PlusNode(std::shared_ptr<ExprNode> leftExpr,
           std::shared_ptr<ExprNode> rightExpr)
...
class TimesNode : public ExprNode {
 public:
  TimesNode(std::shared_ptr<ExprNode> leftExpr,
            std::shared_ptr<ExprNode> rightExpr)
...
class ConstantNode : public ExprNode {
 public:
  ...
  int getIntVal() const { return this->value; }

  std::string getValue() const override { return std::to_string(this->value); }
...
class VariableNode : public ExprNode {
 public:
  ...
  bool isTerminal() const override { return true; }
  std::string getValue() const override { return this->name; }
...
class CondExprNode : public ASTNode {
 public:
  ...
  virtual std::string getOp() { return std::string(""); }
};

class AndNode : public CondExprNode {
 public:
  AndNode(std::shared_ptr<CondExprNode> leftCondExpr,
  ...
  std::string getOp() override { return " && "; }
...
class OrNode : public CondExprNode {
 public:
  OrNode(std::shared_ptr<CondExprNode> leftCondExpr,
         std::shared_ptr<CondExprNode> rightCondExpr)
      : leftCondExpr(leftCondExpr), rightCondExpr(rightCondExpr) {}
  std::shared_ptr<CondExprNode> getLeftCondExpr() const override {
    return this->leftCondExpr;
...
class NotNode : public CondExprNode {
 public:
  NotNode(std::shared_ptr<CondExprNode> condExpr) : condExpr(condExpr) {}
  std::shared_ptr<CondExprNode> getLeftCondExpr() const override {
    return this->condExpr;
  }
  std::string getOp() override { return "!"; }
...
class RelExprNode : public CondExprNode {
 public:
  RelExprNode(std::shared_ptr<ExprNode> leftRelFactor,
...
class GreaterThanNode : public RelExprNode {
 public:
  GreaterThanNode(std::shared_ptr<ExprNode> leftRelFactor,
                  std::shared_ptr<ExprNode> rightRelFactor)
      : RelExprNode(leftRelFactor, rightRelFactor) {}
  std::string getOp() override { return " > "; }
};

class GreaterThanEqualNode : public RelExprNode {
 public:
  GreaterThanEqualNode(std::shared_ptr<ExprNode> leftRelFactor,
                       std::shared_ptr<ExprNode> rightRelFactor)
      : RelExprNode(leftRelFactor, rightRelFactor) {}
  std::string getOp() override { return " >= "; }
};
...
class LesserThanNode : public RelExprNode {
 public:
  LesserThanNode(std::shared_ptr<ExprNode> leftRelFactor,
                 std::shared_ptr<ExprNode> rightRelFactor)
      : RelExprNode(leftRelFactor, rightRelFactor) {}
  std::string getOp() override { return " < "; }
};
...
class LesserThanEqualNode : public RelExprNode {
 public:
  LesserThanEqualNode(std::shared_ptr<ExprNode> leftRelFactor,
                      std::shared_ptr<ExprNode> rightRelFactor)
      : RelExprNode(leftRelFactor, rightRelFactor) {}
  std::string getOp() override { return " <= "; }
};
...
class EqualsNode : public RelExprNode {
 public:
  EqualsNode(std::shared_ptr<ExprNode> leftRelFactor,
             std::shared_ptr<ExprNode> rightRelFactor)
      : RelExprNode(leftRelFactor, rightRelFactor) {}
  std::string getOp() override { return " == "; }
};
...
class NotEqualsNode : public RelExprNode {
 public:
  NotEqualsNode(std::shared_ptr<ExprNode> leftRelFactor,
                std::shared_ptr<ExprNode> rightRelFactor)
      : RelExprNode(leftRelFactor, rightRelFactor) {}
  std::string getOp() override { return " != "; }
};
